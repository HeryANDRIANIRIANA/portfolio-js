class etatSalaireBE{
	...
	*/
	async getAllEtatSalaire(options={}){
		...
		let r="SELECT PAIEMENT.*, PERSONNEL.* FROM PERSONNEL INNER JOIN PAIEMENT ON PERSONNEL.CIN = PAIEMENT.CIN WHERE (((PAIEMENT.Mois)='"+M+"') "+cinCriter+" ) ORDER BY PAIEMENT.NomPrenom DESC;";
